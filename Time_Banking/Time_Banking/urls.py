...
urlpatterns = [
    ...
    path(
        ...
        TemplateView.as_view(template_name="verification_successful.html"),
        name="verification_successful",
    ),
    path(
        "verification-failed/",
        TemplateView.as_view(template_name="verification_failed.html"),
    ...
    path(
        "listing/<int:listing_id>/edit/page/",
        views.edit_listing_page,
