...
class UserSettingsTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="testuser", password=self.Old_password
        )
    ...
    def test_change_valid_password(self):
        ...
        login_response = self.client.login(
            username="testuser", password=self.New_password
        )
    ...
    def test_change_password_not_own(self):
        ...
        self.assertEqual(
            response.json(), {"error": "Not authorized to change password"}
        )
    ...
    def test_change_password_generic_exception(self):
        with patch(
            "Time_Banking.models.User.set_password",
    ...
    def test_delete_account_exception_handling(self):
        with patch(
            "Time_Banking.models.User.delete", side_effect=Exception("Test exception")
        ):
